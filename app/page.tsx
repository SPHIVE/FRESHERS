        ...
        <div className="text-center space-y-5 max-w-xl mx-auto mb-8 pointer-events-auto">
          ...
          <div className="pt-1 flex items-center justify-center">
            <button
              ...
              className="px-8 py-3.5 rounded-full text-xs font-extrabold gold-gradient-btn flex items-center justify-center gap-2.5 group cursor-pointer transition-all uppercase tracking-widest"
            >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pointer-events-auto text-[10px] sm:text-[11px] text-slate-400 font-semibold tracking-widest uppercase">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <a
              ...
              className="w-7 h-7 rounded-full bg-[#081221]/90 border border-[#D8B56A]/30 flex items-center justify-center text-slate-300 hover:text-[#D8B56A] hover:border-[#D8B56A] transition-all shadow-sm"
            >
          ...
          <div className="flex items-center gap-2 text-right">
            ...
            <div className="flex flex-col text-left">
              <span className="text-slate-200 font-bold text-[10px] sm:text-[11px]">100% TRANSPARENT</span>
              <span className="text-[8px] sm:text-[9px] text-slate-400">EVERY PENNY ACCOUNTED FOR</span>
            </div>
          </div>
        </div>
      </div>
